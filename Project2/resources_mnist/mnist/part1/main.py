...
import sys
sys.path.append('C:/Users/gdiaz/Desktop/GDA/cursoMITx/Project2/resources_mnist/mnist/part1')
...
def run_softmax_on_MNIST(temp_parameter=1):
    ...
    theta, cost_function_history = softmax_regression2(train_x, train_y, temp_parameter, alpha=0.3, lambda_factor=1.0e-4, k=10, num_iterations=150)
...
# 
# 
# print('softmax test_error PCA=', run_softmax_on_MNIST(temp_parameter=1))
# 
#==============================================================================
...
def run_softmax_on_MNIST2(temp_parameter=1):
    """
    Trains softmax, classifies test data, computes test error, and plots cost function
...
print('softmax test_errorCUBIC=', run_softmax_on_MNIST2(temp_parameter=1))
#0.0865not the answer
...
theta, cost_function_history = softmax_regression2(train_cube, train_y, temp_parameter=1, alpha= 0.3, lambda_factor = 1.0e-4, k = 10, num_iterations = 150)
# #
plot_cost_function_over_time(cost_function_history)
# #
...
n_components = 10
pcs = principal_components(train_x)
X,featured_means = center_data(train_x)
train_pca10 = project_onto_PC(train_x, pcs, n_components,featured_means )
test_pca10 = project_onto_PC(test_x, pcs, n_components,featured_means )
#
## TODO: First fill out cubicFeatures() function in features.py as the below code requires it.
#
train_cube = cubic_features(train_pca10)
